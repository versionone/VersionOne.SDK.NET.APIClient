module MetaSamplePayloads

let assetTypeType = """
<AssetType name="AssetType"  version="16.1.1.225" token="AssetType" displayname="AssetType'AssetType" abstract="False">
...
let primaryRelationType = """
<AssetType version="16.1.1.225" name="PrimaryRelation" token="PrimaryRelation" displayname="AssetType'PrimaryRelation" abstract="False">
